                        ...
                        <div className="md:flex no-wrap md:-mx-2  ">
                            ...
                            <div className=" w-full md:w-3/12 ">
                                ...
                                <div className=" p-3 ">
                                    ...
                                    <ul className="-mt-3 text-sm font-semibold text-gray-500 hover:text-gray-700 py-2 px-3 divide-y rounded bg-white ">
                            ...
                            <div className="w-full mx-2   md:block lg:block md:-mt-24 sm:mt-0">
                                ...
                                <div className="hidden md:block lg:block">
                                    <ul className="flex bg-white ">
                                        ...
                                        <li className="mr-1">
                                            <a className="rounded-sm bg-white inline-block py-2 px-4 border-l border-t border-r rounded-t text-blue-500 hover:text-blue-800 font-semibold" href="#">leave</a>
                                        </li>
                                        <li className="mr-1">
                                            <a className="rounded-sm bg-white inline-block py-2 px-4 border-l border-t border-r rounded-t text-blue-500 hover:text-blue-800 font-semibold" href="#">Emergency</a>
                                        </li>
                                        <li className="mr-1">
                                            <a className="rounded-sm bg-white inline-block py-2 px-4 border-l border-t border-r rounded-t text-blue-500 hover:text-blue-800 font-semibold" href="#">Document</a>
                                        </li>
                                        <li className="mr-1">
                                            <a className="rounded-sm bg-white inline-block py-2 px-4 border-l border-t border-r rounded-t text-blue-500 hover:text-blue-800 font-semibold" href="#">Notes</a>
                                        </li>
